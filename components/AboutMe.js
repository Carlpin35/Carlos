    ...
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] -mt-10 dark:bg-gray-900">
        <div className="text-container max-w-6xl mx-auto pt-20">
          ...
          >
            {userData.about.title}. I mainly develop using React
        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          ...
          <div className="inline-flex flex-col">
            ...
            <div className="mt-4 ml-4">
              ...
              <div className="flex flex-row justify-start items-center">
                  ...
                  <div className="my-4 mr-2">&rarr;</div>
                  <p className="text-lg text-gray-500 font-mono relative overflow-hidden dark:text-gray-300">
                    <div className="absolute   "></div>
                    Carlpin800@gmail.com
                  </p>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-row flex-wrap mt-8">
              ...
              />
               <img
                src="https://res.cloudinary.com/practicaldev/image/fetch/s--wMCjqhNB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/784/1%2Akmm4E29iST5X569ItIEaKQ.png"
                className="h-20 w-20 mx-4 my-4"
              />
              <img
